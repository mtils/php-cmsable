...
namespace Cmsable\Blog\SiteTreePlugins;
...
class BlogPagePlugin extends ConfigurablePlugin
{
    ...
    protected function createTagFilterField()
    {
        return $this->app->make($this->tagFieldClass)
                         ...
                         ->setTitle(Lang::get('ems::sitetree-plugins.blog-page.filter_tags_ids.title'))
                         ->setOwner($this);
    }
