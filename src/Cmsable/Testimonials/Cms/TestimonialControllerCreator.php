...
namespace Cmsable\Testimonials\Cms;
...
class TestimonialControllerCreator extends ControllerCreator
{
    ...
    public function onIndex(Controller $controller, array $parameters)
    {
        ...
        $this->container['events']->listen('resource::testimonials.query', function($builder) {
